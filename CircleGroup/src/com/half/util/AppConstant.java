...
public class AppConstant {
	...
	public static String SERVER_ADDRESS_FOR_ALERT_LIST = "http://marufnafi.byethost4.com/batalertlist.php?";
	public static String SERVER_ADDRESS_FOR_ADD_ALERT = "http://marufnafi.byethost4.com/batalertadd.php?";
	public static String SERVER_ADDRESS_FOR_INVITATION_LIST = "http://marufnafi.byethost4.com/batinvitationlist.php?";
	public static String SERVER_ADDRESS_FOR_SEND_INVITAION = "http://marufnafi.byethost4.com/batinvitationadd.php?";
	...
	public static int ALL_MEMBER_CALL = 100;
	public static int ALERT_LIST_CALL = 200;
	public static int ADD_ALERT_CALL = 300;
	public static int SCHEDULE_LIST_CALL = 400;
	public static int ADD_SCHEDULE_CALL = 500;
	public static int INVITATION_LIST_CALL = 600;
	public static int SENT_INVITATION_CALL = 700;
	public static int MEDIA_LIST_CALL = 800;
