...
public class CustomAdapter extends BaseAdapter   implements OnClickListener {
         ...
         public View getView(int position, View convertView, ViewGroup parent) {
             ...
             else
             {
                 ...
                 tempValues=null;
                 tempValues = ( User ) data.get( position );
                  
                 /************  Set Model values in Holder elements ***********/
 
                  holder.txtName.setText( tempValues.getName());
                  holder.txtMobileNumber.setText( tempValues.getUrl() );
                   holder.imgProfilePic.setImageResource( res.getIdentifier( "com.half.adapter:drawable/"+tempValues.getImage(),null,null));
